...
import com.example.servisengineering.checkBoxPriut.CheckBoxAdapterPriut
import com.example.servisengineering.checkBoxPriut.CheckBoxDbManagerPriut
...
import com.example.servisengineering.dbPriut.MyAdapterPriut
...
class Priyt : AppCompatActivity() {

    val myDbManager = MyDbManagerPriut(this)   //CREATE DATABASE
    val myAdapter = MyAdapterPriut(ArrayList(), this)  //CREATE RecyclerView ADAPTER
    val checkBoxDbManager = CheckBoxDbManagerPriut(this)
    val checkBoxAdapter = CheckBoxAdapterPriut(this)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_priyt)
        init()
        ...
        val numbers = arrayOf("Контакты:","Денис (завхоз)")
        ...
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                if (numbers[position] == "Денис (завхоз)") {
                    val intent = Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + "+79024758100"))
    ...
    fun onClickNew(view: android.view.View) {
        val i = Intent(this, EditActivityPriut::class.java)
        startActivity(i)
    }
