...
class EditActivity59 : AppCompatActivity() {
    ...
    val OBJECT_KEY: String = "School59"

    val myDbManager = MyDbManager59(this)   //СОЗДАЕМ БАЗУ ДАННЫХ

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_edit59)
        getMyIntents()
    }
